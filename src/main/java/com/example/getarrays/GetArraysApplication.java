...
import static com.example.getarrays.enumaration.Status.SERVER_DOWN;
import static com.example.getarrays.enumaration.Status.SERVER_UP;

@SpringBootApplication
public class GetArraysApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(GetArraysApplication.class, args);
    }
